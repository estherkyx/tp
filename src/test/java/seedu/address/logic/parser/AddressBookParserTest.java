...
public class AddressBookParserTest {
    ...
    public void parseCommand_list() throws Exception {
        ...
        ListCommand command = (ListCommand) parser.parseCommand(
                ListCommand.COMMAND_WORD + " " + PREFIX_CATEGORY + category.toString());
        assertEquals(new ListCommand(category), command);
    }

    @Test
    public void parseCommand_getStudents() throws Exception {
        String tutor = "Aaron Tan";
